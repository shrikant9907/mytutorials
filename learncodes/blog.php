        ...
        <div class="row">
            <div class="col-12 col-sm-6 col-md-8">
                    ...
                    <div class="card-body pri_30 pri_30 pli_30 pbi_30">
                        <h2 class='text-primary'>How to pass data from child to parent component in Angular 7/8/9?</h2>
                        ...
                        <div class="f16">
                        <p>Angular uses the @Output() decorator and an EventEmitter property to share the informationAngular uses the @Output() decorator and an EventEmitter property to share the information from the child component to the parent component...</p>
                        <a class="btn btn-primary btnui3s w-100 text-white text_bold">Continue Reading <i class="ml_5 fas fa-angle-double-right"></i></a>
                        </div>
                    </div>
                </div>                        
            </div>
