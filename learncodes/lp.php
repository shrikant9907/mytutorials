          ...
          <nav class="navbar navbar-expand-lg">
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
              <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                  <a class="nav-link text-dark" href="#test-your-skills">Quizzes</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link text-dark" href="#interview">Interview</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link text-dark" href="#news-and-blog">Blog</a>
                </li>
...
<div class="banner-section bg_black text-white mt_0 min_h_550">
  <img src="images/shrikant_yadav_full.jpg" class="op5 overlay_w" />
  <div class="container">
      <div class="row">
          <div class="col-12">
